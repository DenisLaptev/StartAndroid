package com.a5androidintern2.p0811_handlersimplemessage;
...
public class MainActivity extends Activity {
    ...
    //константы статуса, их будем передавать в атрибуте what.
        ...
        Thread t = new Thread(new Runnable() {
            public void run() {
                try {
                    ...
                    //с помощью TimeUnit.SECONDS.sleep(2) эмулируем какое-то действие,
