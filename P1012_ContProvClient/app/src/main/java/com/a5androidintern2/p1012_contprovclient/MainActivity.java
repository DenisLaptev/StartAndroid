package com.a5androidintern2.p1012_contprovclient;
...
public class MainActivity extends Activity {
    ...
    final Uri CONTACT_URI = Uri
            .parse("content://com.a5androidintern2.providers.AdressBook/contacts");
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //объект ContentResolver - это посредник между нами и провайдером.
        //вызываем на объекте ContentResolver метод query()
        //и передаём туда Uri.
        Cursor cursor = getContentResolver().query(CONTACT_URI, null, null,
                null, null);

        //Полученный курсор мы передаем в Activity на управление.
    ...
    public void onClickError(View v) {
        Uri uri = Uri.parse("content://com.a5androidintern2.providers.AdressBook/phones");
        try {
