...
public class AdapterHelper {
    ...
    //конструктор, через который мы передаём объекту ссылку на контекст.
    //контекст понадобится, чтобы создать адаптер.
...
//чтобы получить адаптер, нужно вызвать метод getAdapter().
    ...
    //методы возвращают название групп/элементов групп по номерам групп/элементов.
